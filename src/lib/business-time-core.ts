// Núcleo de las utilidades de zona horaria de negocio. Vive SEPARADO
// de business-time.ts (que reexporta esto con el guard "server-only"
// encima) — Fase 025: el job CLI de reconciliación de ciclo de vida
...
// ese contexto (mismo motivo que pii-crypto-core.ts, Fase 021/023).
// Toda la app (Server Components/Actions/servicios) debe seguir
// importando "@/lib/business-time", nunca este archivo directamente,
// salvo el job CLI y policy-lifecycle-core.ts.
