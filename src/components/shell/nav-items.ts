...
// Solo "Dashboard", "Contactos", "Pólizas", "Tareas", "Cumpleaños" y
// "Configuración" tienen módulo real en esta fase. El resto queda
// visible (para transmitir el mapa completo del CRM) pero
